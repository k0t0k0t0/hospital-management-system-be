...
class PatientController {
  ...
  public createAppointment: RequestHandler = async (req: Request, res: Response) => {
    const serviceResponse = await patientService.createAppointment(req.body);
    return handleServiceResponse(serviceResponse, res);
  };

  public rescheduleAppointment: RequestHandler = async (req: Request, res: Response) => {
    const id = req.params.id;
    const { dateTime } = req.body;
    const serviceResponse = await patientService.rescheduleAppointment(id, dateTime);
    return handleServiceResponse(serviceResponse, res);
  };

  public updateAppointmentStatus: RequestHandler = async (req: Request, res: Response) => {
    const id = req.params.id;
    const { status, cancelReason } = req.body;
    const serviceResponse = await patientService.updateAppointmentStatus(id, status, cancelReason);
    return handleServiceResponse(serviceResponse, res);
  };

  public getPatientAppointments: RequestHandler = async (req: Request, res: Response) => {
    const patientId = req.params.patientId;
    const serviceResponse = await patientService.getPatientAppointments(patientId);
    return handleServiceResponse(serviceResponse, res);
  };

  public getUpcomingAppointments: RequestHandler = async (req: Request, res: Response) => {
    const patientId = req.params.patientId;
    const serviceResponse = await patientService.getUpcomingAppointments(patientId);
    return handleServiceResponse(serviceResponse, res);
  };
  ...
  public getPatientMessages: RequestHandler = async (req: Request, res: Response) => {
    const patientId = req.params.patientId;
    const serviceResponse = await patientService.getPatientMessages(patientId);
    return handleServiceResponse(serviceResponse, res);
  };

  public getUnreadMessages: RequestHandler = async (req: Request, res: Response) => {
    const patientId = req.params.patientId;
    const serviceResponse = await patientService.getUnreadMessages(patientId);
    return handleServiceResponse(serviceResponse, res);
  };

  public markMessageAsRead: RequestHandler = async (req: Request, res: Response) => {
    const messageId = req.params.messageId;
    const serviceResponse = await patientService.markMessageAsRead(messageId);
    return handleServiceResponse(serviceResponse, res);
  };

  public searchPatients: RequestHandler = async (req: Request, res: Response) => {
    const searchParams = {
  ...
  public getEmergencyInfo: RequestHandler = async (req: Request, res: Response) => {
    const patientId = req.params.id;
    const serviceResponse = await patientService.getEmergencyInfo(patientId);
    return handleServiceResponse(serviceResponse, res);
  };

  public updateEmergencyContact: RequestHandler = async (req: Request, res: Response) => {
    const patientId = req.params.id;
    const serviceResponse = await patientService.updateEmergencyContact(patientId, req.body);
    return handleServiceResponse(serviceResponse, res);
  };

  public recordEmergencyVisit: RequestHandler = async (req: Request, res: Response) => {
